...
public class SpikeRightTile extends Tile {

    /**
     * This constructor is used to create a SpikeRight tile which can kill the
     * player
     * 
     ...
     */
    public SpikeRightTile(World world, int row, int col) {
        super(world, row, col, 1, 8);
    }
