...
public class SpikeDownTile extends Tile {

    /**
     * This constructor is used to create a SpikeDown tile which can kill the player
     * 
     ...
     */
    public SpikeDownTile(World world, int row, int col) {
        super(world, row, col, 3, 8);
    }
