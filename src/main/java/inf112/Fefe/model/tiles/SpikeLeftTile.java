...
public class SpikeLeftTile extends Tile {

    /**
     * This constructor is used to create a SpikeLeft tile which can kill the player
     * 
     ...
     */
    public SpikeLeftTile(World world, int row, int col) {
        super(world, row, col, 2, 8);
    }
    ...
    protected void initBody(World world) {
        ...
        Vector2[] arr = new Vector2[] {
                new Vector2(DIMENSION / 2, -DIMENSION / 2 + 0.1f),
                new Vector2(DIMENSION / 4, -DIMENSION / 2 + 0.1f),
                new Vector2(DIMENSION / 4, DIMENSION / 2 - 0.1f),
                new Vector2(DIMENSION / 2, DIMENSION / 2 - 0.1f)
        };
